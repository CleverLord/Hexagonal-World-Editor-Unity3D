...
{
    [CreateAssetMenu(fileName = "SimpleBehaviour", menuName = "Hex Editor Engine/Pallete behaviours/SimpleBehaviour", order = 1)]
    public class SimpleBehaviour : PaletteBehaviour
    {
